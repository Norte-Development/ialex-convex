import { handleValueDelta } from './deltaValueHandlers';

export type ArrayDeltaHandler = (
  newNode: any,
  oldNode: any,
  delta: any,
  changeId: string,
...
const missingArrayHandler = (): never => {
  throw new Error('applyJsonDelta requires handleArrayDelta to be provided');
};
 ...
 * @param handleArrayDelta - Array delta handler
 */
export function applyJsonDelta(
  ...
  changeId: string,
  path: string[] = [],
  handleArrayDelta: ArrayDeltaHandler = missingArrayHandler
): void {
