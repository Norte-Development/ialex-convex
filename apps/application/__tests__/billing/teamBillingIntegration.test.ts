...
//     // Create premium team with owner subscription (NEW MODEL: team plan = owner plan)
//     premiumTeamId = await t.run(async (ctx) => {
//       const teamId = await ctx.db.insert("teams", {
//         name: "Premium Team",
//         description: "Team owned by premium_team user",
//         createdBy: teamOwnerId,
//         teamLead: teamOwnerId,
//         isActive: true,
//       });

//       // Create Stripe entities for TEAM OWNER (not team)
//       const customerId = `cus_owner_${Date.now()}`;
//       await ctx.db.insert("stripeCustomers", {
//         customerId,
//         entityId: teamOwnerId, // Owner's customer
//         entityType: "user",
//       });
...
//       const subscriptionId = `sub_owner_${Date.now()}`;
