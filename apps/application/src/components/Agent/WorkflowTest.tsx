...
export function WorkflowTest() {
  ...
  const initiateWorkflow = useMutation(api.agent.workflow.initiateWorkflowStreaming);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setContent("");
    void initiateWorkflow({ prompt: content, threadId: threadId || "" })
      .then(({ threadId }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex flex-col gap-12">
          ...
          <form onSubmit={handleSubmit}>
            <div className="relative">
              <textarea
                ...
                placeholder="Ask your legal question or request assistance..."
              />
              <button
                type="submit"
              ...
              >
                <span>Start Legal Workflow</span>
                {content.trim() && (
                  <svg
        ...
        {messages.results.find((m) => m.agentName === "iAlex - Agente Legal") && (
          <>
            <form
              onSubmit={(e) => {
                e.preventDefault();
