...
import { AcceptAllChangesButton } from "../Editor/AcceptAllChangesButton";
...
export function ChatContent() {
  ...
  const handleLoadMore = async () => {
    if (!messages.loadMore || isLoadingMore || !messagesContainerRef.current)
      return;
  ...
  const abortStreamByOrder = useMutation(
    api.agent.streamAbort.abortStreamByOrder,
  );
