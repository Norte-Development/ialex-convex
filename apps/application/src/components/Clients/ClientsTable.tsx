...
// Helper para obtener iniciales del displayName
      ...
      <Table className="w-full">
        ...
        <TableBody className="">
          {clients.map((client: any, index: number) => {
            ...
            const displayName =
              client.displayName || client.name || "Sin nombre";
                ...
                <TableCell className="">
                  <div className="flex items-center gap-2">
                    <Avatar className="w-8 h-8">
                      <AvatarFallback
                        className={`text-sm font-medium ${isHumana ? "bg-blue-100 text-blue-600" : "bg-purple-100 text-purple-600"}`}
                      >
                  ...
                  <div className="flex items-center gap-1.5">
                    {isHumana ? (
                      <>
                        ...
                        <span className="text-sm">Persona Humana</span>
                      </>
                    ) : (
                      <>
