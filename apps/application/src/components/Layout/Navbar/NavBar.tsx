...
export default function NavBar() {
  ...
  return (
    <nav
      className={`flex flex-row-reverse bg-white ${isInCaseContext ? "relative pt-5" : "fixed"} px-5 justify-between items-center py-1 h-[41px] w-full text-foreground ${!isInCaseContext ? "top-0 left-0" : ""} z-50 mb-5`}
    >
