        ...
        <div className="bg-white border border-gray-200  rounded-lg shadow-lg overflow-hidden min-w-[160px]">
          {options.map((option) => (
            <div className="flex w-full justify-between items-center mt-3">
              <div className="bg-[#1868D8] w-2 h-[35px] rounded-r-2xl" />
              <Link
                key={option.path}
                to={option.path}
                className="block px-4  py-2.5 text-sm w-full text-gray-700 hover:bg-blue-50/50 hover:text-[#1868D8] transition-colors"
