...
export default function CaseGrid({ 
  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-3 sm:gap-4 overflow-y-auto h-[calc(100vh-280px)] sm:h-[calc(100vh-280px)]">
        {cases?.map((caseItem) => (
          <CaseCard
            key={caseItem._id}
            caseId={caseItem._id}
