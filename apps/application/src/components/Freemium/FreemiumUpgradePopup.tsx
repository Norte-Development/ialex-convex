...
export function FreemiumUpgradePopup() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && close()}>
      <DialogContent className="w-full max-w-[95vw] sm:max-w-[900px] max-h-[90vh] p-0 overflow-hidden bg-gradient-to-br from-[#130261] to-[#1a0880] text-white border-[#130261] shadow-2xl">
        <div className="flex flex-col md:flex-row h-full w-full">
            {/* Branding Section */}
            <div className="w-full md:w-5/12 bg-gradient-to-br from-[#130261] via-[#1a0880] to-black relative min-h-[200px] md:min-h-full flex flex-col items-center justify-center p-6 md:p-8 overflow-hidden">
                {/* Decorative elements */}
                ...
                <div className="relative z-10 text-center space-y-4">
                    ...
                    <p className="text-purple-200 text-lg font-medium leading-relaxed">
                        Lleva tu práctica legal al siguiente nivel con IA ilimitada
                    </p>
                </div>
            </div>

            {/* Content Section */}
            <div className="w-full md:w-7/12 p-4 md:p-8 flex flex-col bg-white text-gray-900 relative h-full">
