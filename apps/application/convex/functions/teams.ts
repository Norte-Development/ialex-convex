...
export const addUserToTeam = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!isTeamLead && !isTeamAdmin) {
      throw new Error(
        "Unauthorized: Only team leads and team admins can add members",
      );
    }
...
export const removeUserFromTeam = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!isTeamLead && !isTeamAdmin) {
      throw new Error(
        "Unauthorized: Only team leads and team admins can remove members",
      );
    }
...
export const leaveTeam = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (team.teamLead === currentUser._id) {
      throw new Error(
        "Team lead cannot leave team. Please transfer leadership first.",
      );
    }
...
export const sendTeamInvite = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!isTeamLead && !isTeamAdmin) {
      throw new Error(
        "No autorizado: Solo líderes de equipo y administradores pueden enviar invitaciones",
      );
    }
...
export const cancelTeamInvite = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!isTeamLead && !isTeamAdmin && !isInviteCreator) {
      throw new Error(
        "No autorizado: Solo líderes de equipo, administradores o quien envió la invitación pueden cancelarla",
      );
    }
...
export const getTeamInvites = query({
  ...
  handler: async (ctx, args) => {
    ...
    if (!isTeamLead && !userMembership) {
      throw new Error(
        "Solo los miembros del equipo pueden ver las invitaciones",
      );
    }
...
export const resendTeamInvite = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!isTeamLead && !isTeamAdmin) {
      throw new Error(
        "No autorizado: Solo líderes de equipo y administradores pueden reenviar invitaciones",
      );
    }
